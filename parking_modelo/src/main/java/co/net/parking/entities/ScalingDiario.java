...
@Entity
@Table(name = "parking_scaling_diario")
public class ScalingDiario {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScalingDiario other = (ScalingDiario) obj;
		if (ano == null) {
			if (other.ano != null)
				return false;
	...
	public String toString() {
		return "ScallingDiario [id=" + id + ", proyecto=" + proyecto + ", codPark=" + codPark + ", dia=" + dia
				+ ", mes=" + mes + ", ano=" + ano + ", cantidadCarros=" + cantidadCarros + ", cumplimiento="
				+ cumplimiento + "]";
	}
