 ...
 */
@Entity
@Table(name = "trans_v131")
@NamedQueries({ @NamedQuery(name = "TransV130Backup.findAll", query = "SELECT t FROM TransV130Backup t"),
		@NamedQuery(name = "TransV130Backup.consultaPorTerminalPorFactura", query = "SELECT t FROM TransV130Backup t where codTerminal=:codTerminal and numFactura=:numFactura"),
		@NamedQuery(name = "TransV130Backup.consultaTerminalFactura", query = "SELECT t FROM TransV130Backup t where codTerminal=:codTerminal and numFactura=:numFactura"),
		@NamedQuery(name = "TransV130Backup.consultaPorTerminalPorTransaccion", query = "SELECT t FROM TransV130Backup t where codTerminal=:codTerminal and idTransaccion=:numTransaccion"),
		@NamedQuery(name = "TransV130Backup.consultaPorTerminalPorFacturaPorFechaPorValor", query = "SELECT t FROM TransV130Backup t where t.codTerminal=:codTerminal and t.numFactura=:numFactura and t.fechaFinal=:fechaFinal and t.total= :total"),
		@NamedQuery(name = "TransV130BackupPrimeraFacturaIdTurno", query = "SELECT t FROM TransV130Backup t where codTerminal=:codTerminal and idInicioTurno=:idInicioTurno and tipo_trans<>4 and num_factura<>0 ORDER BY fecha_final ASC "),
		@NamedQuery(name = "TransV130BackupUltimaFacturaIdTurno", query = "SELECT t FROM TransV130Backup t where codTerminal=:codTerminal and idInicioTurno=:idInicioTurno and tipo_trans<>4 and num_factura<>0 ORDER BY fecha_final DESC"),
		@NamedQuery(name = "TransV130BackupTotalEfectivoCierreTurno", query = "SELECT t FROM TransV130Backup t where codTerminal=:codTerminal and idInicioTurno=:idInicioTurno and tipo_trans<>4 and num_factura<>0 and total>0" ),
		@NamedQuery(name = "TransV130BackupNumFacturaTrans", query = "SELECT t FROM TransV130Backup t WHERE tipoTrans<>4 and numFactura<>0 and codTerminal=:codTerminal ORDER by numFactura desc")

		
})
@JsonIgnoreProperties(ignoreUnknown = true)
public class TransV130Backup implements Serializable {
