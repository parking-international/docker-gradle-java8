...
public class Email {
    ...
    private static final String EM_REMITENTE = "noreply@parking.net.co";
    private static final String EM_PASSWORD = "Pa$2017*";
    ...
    public void cargarPlantilla(){
        ...
        try {
            InputStream in = getClass().getResourceAsStream("/plantilla-email.html");
    ...
    private File getImage() throws IOException {
        InputStream in = getClass().getResourceAsStream("/logo.png");
